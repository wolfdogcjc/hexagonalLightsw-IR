...
void translateIR()
{
  switch(results.value)
  {
    ...
    case 0xB4B4FC03: MonoBlue(); Serial.println("5");     break; //StaticColour(155); Program = 6 &&
    case 0xB4B402FD: outinlight(); Serial.println("6");     break;
    case 0xB4B4827D: christmas(); Serial.println("7");     break;
    case 0xB4B442BD:  Serial.println("8");     break;
    case 0xB4B4C23D:  Serial.println("9");     break;
...
void MonoBlue() {
  Strip1[0].setRGB(0,255,0);
  Strip1[1].setRGB(100,255,100);
  Strip1[2].setRGB(120,255,120);
  Strip1[3].setRGB(165,255,165);
  Strip1[4].setRGB(225,255,225);
  Strip1[5].setRGB(255,255,255);
  FastLED.show();
